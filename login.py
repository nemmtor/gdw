...
from config import brwid, font9, font10, font12, font12b
...
class Login(Window):
    ...
    def widgets(self):
        ...
        self.login_entry = tk.Entry(page_frame, width=30, borderwidth=brwid, font=font9)
        ...
        self.password_entry = tk.Entry(page_frame, width=30, show='*', borderwidth=brwid, font=font9)
